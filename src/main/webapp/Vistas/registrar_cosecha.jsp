...
<%
    ...
    List<Cosecha> listaCosechas = (List<Cosecha>) request.getAttribute("listaCosechas");

    String msgCosecha = (String) session.getAttribute("msgOk");
%>
...
<html lang="es">
    <head>
        <meta charset="UTF-8">
        <title>SICULTIVO - Registrar Cosecha</title>
    ...
    <body class="bg-light">
            ...
            <div class="row">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 p-4 main-content-bg main-scroll-area">
                    ...
                    <div class="bg-white bg-opacity-75 p-4 rounded shadow-sm mb-4">
                        <h3 class="mb-3">Registrar Cosecha</h3>
                        <p class="text-muted">
                            Registre las cosechas obtenidas de un cultivo existente, indicando fecha,
                            cantidad, calidad y observaciones. Los campos marcados con
                            <span class="text-danger">*</span> son obligatorios.
                        </p>

                        <form class="row g-3" action="<%=ctx%>/LoginServlet" method="post">
                            <input type="hidden" name="action" value="guardarCosecha">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-text">
                                    Si no existen cultivos registrados, es necesario registrar al menos uno antes.
                                </div>
                            </div>

                            <div class="col-md-3">
                                <label class="form-label">Fecha de cosecha <span class="text-danger">*</span></label>
                                <input type="date" name="fechaCosecha" class="form-control" required>
                            </div>

                            <div class="col-md-3">
                                <label class="form-label">Cantidad obtenida (kg) <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-4">
                                <label class="form-label">
                                    Calidad de la cosecha <span class="text-danger">*</span>
                                </label>
                                ...
                                <select name="calidad" class="form-select" required>
                                    ...
                                    <%
                                        List<String> listaCalidad
                                                = (List<String>) request.getAttribute("listaCalidad");

                                        if (listaCalidad != null) {
                                            for (String est : listaCalidad) {
                                    %>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control" name="observaciones" rows="2"
                                          placeholder="Notas sobre rendimiento, problemas detectados, condiciones del clima, etc."></textarea>
                            </div>
                            ...
                            <div class="col-12 d-flex justify-content-end gap-2 mt-3">
                                ...
                                <button type="submit" class="btn btn-success btn-sm d-flex align-items-center">
                                    <img src="<%=ctx%>/img/icon_guardar.png" class="crud-icon me-2" alt="Guardar cosecha">
                                    Guardar
                                </button>
                            </div>
                        </form>
                    ...
                    <div class="bg-white bg-opacity-75 p-4 rounded shadow-sm">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h5 class="mb-0">Listado general de cosechas</h5>
                        </div>

                        <!-- ✅ EXPORTAR PDF POR RANGO -->
                        <form action="<%=ctx%>/LoginServlet" method="post" class="mb-3">
                            <input type="hidden" name="action" value="exportarCosechasPdf">
                            ...
                            <div class="d-flex justify-content-end align-items-end gap-2 flex-wrap">
                                ...
                                <button type="submit"
                                    ...
                                    <!-- si no tienes icon_pdf.png, borra esta línea o cambia el icono -->
                                    <img src="<%=ctx%>/img/icon_pdf.png" class="crud-icon me-1" alt="PDF">
                                    Exportar PDF
                                </button>
                            </div>
                        </form>
                        ...
                        <!-- BUSCADOR NORMAL -->
                        <form action="<%=ctx%>/LoginServlet" method="post" class="mb-3">
                            <input type="hidden" name="action" value="cosechas">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-sm align-middle">
                                ...
                                <tbody>
                                    <%
                                        if (listaCosechas != null && !listaCosechas.isEmpty()) {
                                            for (Cosecha co : listaCosechas) {
                                    %>
                                    <tr>
                                        <td><%=co.getNombreCultivo()%></td>
                                        <td><%=co.getFechaCosecha()%></td>
                                        <td><%=co.getCantidad()%></td>
                                        <td><%=co.getCalidad()%></td>
                                        <td><%=co.getObservaciones()%></td>
                                        <td class="text-center">
                                            <div class="d-inline-flex gap-2">
                                                <a class="btn btn-warning btn-sm d-inline-flex align-items-center"
                                                   href="<%=ctx%>/LoginServlet?action=editarCosecha&id=<%=co.getIdCosecha()%>">
                                                ...
                                                <button type="button"
                                                        ...
                                                        data-bs-target="#modalEliminarCosecha"
                                                        data-id="<%= co.getIdCosecha()%>">
                    ...
                    <!-- MODAL ELIMINAR -->
                    <div class="modal fade" id="modalEliminarCosecha" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ¿Desea eliminar esta cosecha?
                                </div>

                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                                    <a id="btnConfirmEliminarCosecha" class="btn btn-danger">Sí, eliminar</a>
                                </div>
        ...
        <script>
            const modalCosecha = document.getElementById('modalEliminarCosecha');
            modalCosecha.addEventListener('show.bs.modal', function (event) {
                const btn = event.relatedTarget;
                const id = btn.getAttribute('data-id');

                document.getElementById('btnConfirmEliminarCosecha').href =
                        '<%=ctx%>/LoginServlet?action=eliminarCosecha&id=' + id;
            });
        </script>
